...
const invoiceSchema = new mongoose.Schema(
  {
    ...
    senderDetails: {
      companyName: { type: String, default: 'H.A. OVERSEAS' },
      address: { type: String, default: 'Industrial Area Phase-II, Ludhiana, Punjab - 141003, India' },
      phoneNumber: { type: String, default: '+91-99884-65800' },
      email: { type: String, default: 'haoverseas1313@gmail.com' },
      gstin: { type: String, default: '03AAAAA0000A1Z5' },
      iecNo: { type: String, default: '0300000000' },
      pan: { type: String, default: 'AAAAA0000A' },
      stateCode: { type: String, default: '03' },
    },
